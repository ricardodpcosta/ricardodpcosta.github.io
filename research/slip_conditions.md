...
<div class="row">
  <div class="column" style="width:50%; text-align:center;">
    <img style="width:40%; display:block; margin-left:auto; margin-right:auto;" src="{{ site.baseurl }}../public/boundary_minimum_curvature.png">
  </div>
  <div class="column" style="width:50%; text-align:center;">
    <img style="width:40%; display:block; margin-left:auto; margin-right:auto;" src="{{ site.baseurl }}../public/boundary_maximum_curvature.png">
  </div>
</div>
 <div class="row">
  <div class="column" style="width:50%; text-align:center;">
